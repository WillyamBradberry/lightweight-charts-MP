 ...
 * (the arrow head) is defined purely in the Model's options (`line.end.right`). The
 * parent view's `_updateImpl` reads these options and passes them to the
 * `SegmentRenderer`, which handles drawing the arrow cap automatically.
 */
export class LineToolArrowPaneView<HorzScaleItem> extends LineToolTrendLinePaneView<HorzScaleItem> {
	 ...
	 */
	public constructor(
		source: LineToolArrow<HorzScaleItem>,
