 ...
 * It checks the `options.line.extend` property (which the Horizontal Ray model sets to
 * `{ left: false, right: true }`) and calculates the start/end points of the segment accordingly.
 */
export class LineToolHorizontalRayPaneView<HorzScaleItem> extends LineToolHorizontalLinePaneView<HorzScaleItem> {
	 ...
	 */
	public constructor(
		source: LineToolHorizontalRay<HorzScaleItem>,
